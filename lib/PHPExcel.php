...
if (!defined('Plugins_PHPEXCEL_ROOT')) {
    define('Plugins_PHPEXCEL_ROOT', dirname(__FILE__) . '/Plugins/');
...
class PHPExcel
{
     ...
     * Document properties
     *
     * @var Plugins_PHPExcel_DocumentProperties
     */
    private $_properties;
     ...
     * Document security
     *
     * @var Plugins_PHPExcel_DocumentSecurity
     */
    private $_security;
	 ...
	 * Calculation Engine
	 *
	 * @var Plugins_PHPExcel_Calculation
	 */
     ...
     * Named ranges
     *
     * @var Plugins_PHPExcel_NamedRange[]
     */
	...
	*/
	...
	public function __construct()
	{
		...
		$this->_calculationEngine	= Plugins_PHPExcel_Calculation::getInstance($this);

		// Initialise worksheet collection and add one worksheet
		$this->_workSheetCollection = array();
		$this->_workSheetCollection[] = new Plugins_PHPExcel_Worksheet($this);
		$this->_activeSheetIndex = 0;

        // Create document properties
        $this->_properties = new Plugins_PHPExcel_DocumentProperties();

        // Create document security
        $this->_security = new Plugins_PHPExcel_DocumentSecurity();

        // Set named ranges
        $this->_namedRanges = array();

        // Create the cellXf supervisor
        $this->_cellXfSupervisor = new Plugins_PHPExcel_Style(true);
        $this->_cellXfSupervisor->bindParent($this);

        // Create the default style
        $this->addCellXf(new Plugins_PHPExcel_Style);
        $this->addCellStyleXf(new Plugins_PHPExcel_Style);
    }
    ...
    public function __destruct() {
        Plugins_PHPExcel_Calculation::unsetInstance($this);
	 ...
	 *
	 * @return Plugins_PHPExcel_Calculation
	 */
     ...
     * Get properties
     *
     * @return Plugins_PHPExcel_DocumentProperties
     */
     ...
     * Set properties
     *
     * @param Plugins_PHPExcel_DocumentProperties    $pValue
     */
    public function setProperties(Plugins_PHPExcel_DocumentProperties $pValue)
    {
     ...
     * Get security
     *
     * @return Plugins_PHPExcel_DocumentSecurity
     */
     ...
     * Set security
     *
     * @param Plugins_PHPExcel_DocumentSecurity    $pValue
     */
    public function setSecurity(Plugins_PHPExcel_DocumentSecurity $pValue)
    {
    ...
    {
        $newSheet = new Plugins_PHPExcel_Worksheet($this);
     ...
     * @throws Plugins_PHPExcel_Exception
     */
    public function addSheet(Plugins_PHPExcel_Worksheet $pSheet, $iSheetIndex = NULL)
    {
        if ($this->sheetNameExists($pSheet->getTitle())) {
            throw new Plugins_PHPExcel_Exception(
     ...
     * @throws Plugins_PHPExcel_Exception
     */
    public function getIndex(Plugins_PHPExcel_Worksheet $pSheet)
    {
        ...
        throw new Plugins_PHPExcel_Exception("Sheet does not exist.");
    }
    ...
    {
        if (($worksheet = $this->getSheetByName($pValue)) instanceof Plugins_PHPExcel_Worksheet) {
            $this->setActiveSheetIndex($this->getIndex($worksheet));
            return $worksheet;
        }

        throw new Plugins_PHPExcel_Exception('Workbook does not contain sheet:' . $pValue);
    }
     ...
     * Add external sheet
     *
     * @param  Plugins_PHPExcel_Worksheet $pSheet External sheet to add
     * @param  int|null $iSheetIndex Index where sheet should go (0,1,..., or null for last)
     * @throws Plugins_PHPExcel_Exception
     * @return Plugins_PHPExcel_Worksheet
     */
    public function addExternalSheet(Plugins_PHPExcel_Worksheet $pSheet, $iSheetIndex = null) {
        if ($this->sheetNameExists($pSheet->getTitle())) {
            throw new Plugins_PHPExcel_Exception("Workbook already contains a worksheet named '{$pSheet->getTitle()}'. Rename the external sheet first.");
        }
     ...
     * Get named ranges
     *
     * @return Plugins_PHPExcel_NamedRange[]
     */
     ...
     * Add named range
     *
     * @param  Plugins_PHPExcel_NamedRange $namedRange
     * @return PHPExcel
     */
    public function addNamedRange(Plugins_PHPExcel_NamedRange $namedRange) {
     ...
     * @param  Plugins_PHPExcel_Worksheet|null $pSheet Scope. Use null for global scope
     * @return Plugins_PHPExcel_NamedRange|null
     */
    public function getNamedRange($namedRange, Plugins_PHPExcel_Worksheet $pSheet = null) {
        $returnValue = null;
     ...
     * @return PHPExcel
     */
    public function removeNamedRange($namedRange, Plugins_PHPExcel_Worksheet $pSheet = null) {
        if ($pSheet === NULL) {
            if (isset($this->_namedRanges[$namedRange])) {
     ...
     *
     * @return Plugins_PHPExcel_WorksheetIterator
     */
    public function getWorksheetIterator() {
        return new Plugins_PHPExcel_WorksheetIterator($this);
    }
     ...
     *
     * @param  string $pValue
     * @return Plugins_PHPExcel_Style|false
     */
     ...
     *
     * @param  Plugins_PHPExcel_Style $pCellStyle
     * @return boolean
     */
    ...
    public function getDefaultStyle()
    {
        ...
        throw new Plugins_PHPExcel_Exception('No default style found for this workbook');
    }

    /**
     * Add a cellXf to the workbook
     *
     * @param Plugins_PHPExcel_Style $style
     */
    public function addCellXf(Plugins_PHPExcel_Style $style)
    {
    ...
    public function removeCellXfByIndex($pIndex = 0)
    {
        if ($pIndex > count($this->_cellXfCollection) - 1) {
            throw new Plugins_PHPExcel_Exception("CellXf index is out of bounds.");
        } else {
     ...
     *
     * @param Plugins_PHPExcel_Style $pStyle
     */
    public function addCellStyleXf(Plugins_PHPExcel_Style $pStyle)
    {
    ...
    public function removeCellStyleXfByIndex($pIndex = 0)
    {
        if ($pIndex > count($this->_cellStyleXfCollection) - 1) {
            throw new Plugins_PHPExcel_Exception("CellStyleXf index is out of bounds.");
        } else {
    ...
    public function garbageCollect()
    {
        ...
        if (empty($this->_cellXfCollection)) {
            $this->_cellXfCollection[] = new Plugins_PHPExcel_Style();
        }
