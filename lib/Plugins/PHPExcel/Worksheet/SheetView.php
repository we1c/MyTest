...
/**
 * Plugins_PHPExcel_Worksheet_SheetView
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Worksheet_SheetView
{
    ...
    /**
     * Create a new Plugins_PHPExcel_Worksheet_SheetView
     */
	...
	public function setZoomScale($pValue = 100) {
		...
		if (($pValue >= 1) || is_null($pValue)) {
			...
			throw new Plugins_PHPExcel_Exception("Scale must be greater than or equal to 1.");
		}
		return $this;
	}
	...
	public function setView($pValue = NULL) {
		...
		if (in_array($pValue, self::$_sheetViewTypes)) {
			...
			throw new Plugins_PHPExcel_Exception("Invalid sheetview layout type.");
		}
