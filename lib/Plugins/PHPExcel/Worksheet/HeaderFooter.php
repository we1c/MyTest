...
/**
 * Plugins_PHPExcel_Worksheet_HeaderFooter
 *
 * <code>
 ...
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Worksheet_HeaderFooter
{
	 ...
	 *
	 * @var Plugins_PHPExcel_Worksheet_HeaderFooterDrawing[]
	 */
	private $_headerFooterImages = array();

    /**
     * Create a new Plugins_PHPExcel_Worksheet_HeaderFooter
     */
     ...
     *
     * @param Plugins_PHPExcel_Worksheet_HeaderFooterDrawing $image
     * @param string $location
     * @throws Plugins_PHPExcel_Exception
     * @return Plugins_PHPExcel_Worksheet_HeaderFooter
     */
    public function addImage(Plugins_PHPExcel_Worksheet_HeaderFooterDrawing $image = null, $location = self::IMAGE_HEADER_LEFT) {
     ...
     *
     * @param Plugins_PHPExcel_Worksheet_HeaderFooterDrawing[] $images
     * @throws Plugins_PHPExcel_Exception
     * @return Plugins_PHPExcel_Worksheet_HeaderFooter
     */
    public function setImages($images) {
    	if (!is_array($images)) {
    		throw new Plugins_PHPExcel_Exception('Invalid parameter!');
    	}
     ...
     *
     * @return Plugins_PHPExcel_Worksheet_HeaderFooterDrawing[]
     */
