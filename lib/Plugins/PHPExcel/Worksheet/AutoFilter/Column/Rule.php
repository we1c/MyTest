...
/**
 * Plugins_PHPExcel_Worksheet_AutoFilter_Column_Rule
 *
 * @category	PHPExcel
 * @package		Plugins_PHPExcel_Worksheet
 * @copyright	Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Worksheet_AutoFilter_Column_Rule
{
...
//	const AUTOFILTER_COLUMN_RULE_ALLDATESINQUARTER	= 'allDatesInQuarter';	//	<dynamicFilter type="Q2"/> for Quarter 2
	 ...
	 * Autofilter Column
	 *
	 * @var Plugins_PHPExcel_Worksheet_AutoFilter_Column
	 */
	...
	/**
	 * Create a new Plugins_PHPExcel_Worksheet_AutoFilter_Column_Rule
	 *
	 * @param Plugins_PHPExcel_Worksheet_AutoFilter_Column $pParent
	 */
	public function __construct(Plugins_PHPExcel_Worksheet_AutoFilter_Column $pParent = NULL)
	{
	...
	public function setRuleType($pRuleType = self::AUTOFILTER_RULETYPE_FILTER) {
		if (!in_array($pRuleType,self::$_ruleTypes)) {
			throw new Plugins_PHPExcel_Exception('Invalid rule type for column AutoFilter Rule.');
		}
	...
	public function setValue($pValue = '') {
		if (is_array($pValue)) {
			...
			if (count($pValue) == 0) {
				throw new Plugins_PHPExcel_Exception('Invalid rule value for column AutoFilter Rule.');
			}
	...
	public function setOperator($pOperator = self::AUTOFILTER_COLUMN_RULE_EQUAL) {
		...
		if ((!in_array($pOperator,self::$_operators)) &&
			...
			throw new Plugins_PHPExcel_Exception('Invalid operator for column AutoFilter Rule.');
		}
	 ...
	 *
	 * @param Plugins_PHPExcel_Worksheet_AutoFilter_Column
	 * @return Plugins_PHPExcel_Worksheet_AutoFilter_Column_Rule
	 */
	public function setParent(Plugins_PHPExcel_Worksheet_AutoFilter_Column $pParent = NULL) {
		$this->_parent = $pParent;
