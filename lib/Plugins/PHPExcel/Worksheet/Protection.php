...
/**
 * Plugins_PHPExcel_Worksheet_Protection
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Worksheet
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Worksheet_Protection
{
	/**
	 * Sheet
	 *
    ...
    /**
     * Create a new Plugins_PHPExcel_Worksheet_Protection
     */
    ...
    function setPassword($pValue = '', $pAlreadyHashed = false) {
    	if (!$pAlreadyHashed) {
    		$pValue = Plugins_PHPExcel_Shared_PasswordHasher::hashPassword($pValue);
    	}
