...
/**
 * Plugins_PHPExcel_Chart_Legend
 *
 * @category	PHPExcel
 * @package		Plugins_PHPExcel_Chart
 * @copyright	Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Chart_Legend
{
	/** Legend positions */
	...
	/**
	 *	Create a new Plugins_PHPExcel_Chart_Legend
	 */
	public function __construct($position = self::POSITION_RIGHT, Plugins_PHPExcel_Chart_Layout $layout = NULL, $overlay = FALSE)
	{
