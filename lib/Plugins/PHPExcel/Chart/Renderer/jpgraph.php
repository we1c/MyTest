 ...
 *
 * @category	PHPExcel
 * @package		Plugins_PHPExcel_Chart_Renderer
...
require_once(Plugins_PHPExcel_Settings::getChartRendererPath().'/jpgraph.php');


/**
 * Plugins_PHPExcel_Chart_Renderer_jpgraph
 *
 * @category	PHPExcel
 * @package		Plugins_PHPExcel_Chart_Renderer
 * @copyright	Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Chart_Renderer_jpgraph
{
	...
	private function _formatDataSetLabels($groupID, $datasetLabels, $labelCount, $rotation = '') {
		...
		foreach($datasetLabels as $i => $datasetLabel) {
			if (is_array($datasetLabel)) {
				...
				if (!is_null($datasetLabelFormatCode)) {
					$datasetLabels[$i] = Plugins_PHPExcel_Style_NumberFormat::toFormattedString($datasetLabel,$datasetLabelFormatCode);
				}
			}
			++$testCurrentIndex;
		}
	...
	/**
	 * Create a new Plugins_PHPExcel_Chart_Renderer_jpgraph
	 */
	public function __construct(Plugins_PHPExcel_Chart $chart)
	{
		$this->_graph	= null;
		$this->_chart	= $chart;
