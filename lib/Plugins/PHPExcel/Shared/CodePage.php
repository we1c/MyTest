...
/**
 * Plugins_PHPExcel_Shared_CodePage
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Shared_CodePage
{
	/**
	...
	public static function NumberToName($codePage = 1252)
	{
		switch ($codePage) {
			...
			case 720:	throw new Plugins_PHPExcel_Exception('Code page 720 not supported.');
													break;	//	OEM Arabic
			...
			case 32769:	throw new Plugins_PHPExcel_Exception('Code page 32769 not supported.');
													break;	//	ANSI Latin I (BIFF2-BIFF3)
			case 65000:	return 'UTF-7';				break;	//	Unicode (UTF-7)
			case 65001:	return 'UTF-8';				break;	//	Unicode (UTF-8)
		}

		throw new Plugins_PHPExcel_Exception('Unknown codepage: ' . $codePage);
	}
