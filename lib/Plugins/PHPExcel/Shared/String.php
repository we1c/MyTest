...
/**
 * Plugins_PHPExcel_Shared_String
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Shared
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Shared_String
{
	/**	Constants				*/
	/**	Regular Expressions		*/
	//	Fraction
	...
	public static function convertToNumberIfFraction(&$operand) {
		if (preg_match('/^'.self::STRING_REGEXP_FRACTION.'$/i', $operand, $match)) {
			...
			$operand = Plugins_PHPExcel_Calculation::getInstance()->_calculateFormulaValue($fractionFormula);
			return true;
		}
		return false;
	...
	/**
	 * Set the decimal separator. Only used by Plugins_PHPExcel_Style_NumberFormat::toFormattedString()
	 * to format output by Plugins_PHPExcel_Writer_HTML and Plugins_PHPExcel_Writer_PDF
	 *
	...
	/**
	 * Set the thousands separator. Only used by Plugins_PHPExcel_Style_NumberFormat::toFormattedString()
	 * to format output by Plugins_PHPExcel_Writer_HTML and Plugins_PHPExcel_Writer_PDF
	 *
	...
	/**
	 * Set the currency code. Only used by Plugins_PHPExcel_Style_NumberFormat::toFormattedString()
	 *		to format output by Plugins_PHPExcel_Writer_HTML and Plugins_PHPExcel_Writer_PDF
	 *
