...
require_once Plugins_PHPExcel_ROOT . 'PHPExcel/Shared/trend/bestFitClass.php';
require_once Plugins_PHPExcel_ROOT . 'PHPExcel/Shared/JAMA/Matrix.php';


/**
 * Plugins_PHPExcel_Polynomial_Best_Fit
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Shared_Trend
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Polynomial_Best_Fit extends Plugins_PHPExcel_Best_Fit
{
	/**
