...
/**
 * Plugins_PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Shared_Escher
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Shared_Escher_DgContainer_SpgrContainer_SpContainer
{
	/**
	 ...
	 *
	 * @return Plugins_PHPExcel_Shared_Escher_DgContainer_SpgrContainer
	 */
	...
	public function getNestingLevel()
	{
		...
		while ($parent instanceof Plugins_PHPExcel_Shared_Escher_DgContainer_SpgrContainer) {
			++$nestingLevel;
