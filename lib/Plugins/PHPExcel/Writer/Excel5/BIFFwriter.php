...
/**
 * Plugins_PHPExcel_Writer_Excel5_BIFFwriter
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Writer_Excel5
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Writer_Excel5_BIFFwriter
{
	/**
	...
	public static function getByteOrder()
	{
		if (!isset(self::$_byte_order)) {
			...
			if ($number == $teststr) {
				...
				throw new Plugins_PHPExcel_Writer_Exception("Required floating point format not supported on this platform.");
			}
