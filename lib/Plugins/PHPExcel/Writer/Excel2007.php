...
/**
 * Plugins_PHPExcel_Writer_Excel2007
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Writer_2007
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Writer_Excel2007 extends Plugins_PHPExcel_Writer_Abstract implements Plugins_PHPExcel_Writer_IWriter
{
	/**
	 ...
	 *
	 * @var Plugins_PHPExcel_Writer_Excel2007_WriterPart[]
	 */
	...
	/**
	 * Private unique Plugins_PHPExcel_Style_Conditional HashTable
	 *
	 * @var Plugins_PHPExcel_HashTable
	 */
	private $_stylesConditionalHashTable;

	/**
	 * Private unique Plugins_PHPExcel_Style HashTable
	 *
	 * @var Plugins_PHPExcel_HashTable
	 */
	...
	/**
	 * Private unique Plugins_PHPExcel_Style_Fill HashTable
	 *
	 * @var Plugins_PHPExcel_HashTable
	 */
	...
	/**
	 * Private unique Plugins_PHPExcel_Style_Font HashTable
	 *
	 * @var Plugins_PHPExcel_HashTable
	 */
	...
	/**
	 * Private unique Plugins_PHPExcel_Style_Borders HashTable
	 *
	 * @var Plugins_PHPExcel_HashTable
	 */
	...
	/**
	 * Private unique Plugins_PHPExcel_Style_NumberFormat HashTable
	 *
	 * @var Plugins_PHPExcel_HashTable
	 */
	...
	/**
	 * Private unique Plugins_PHPExcel_Worksheet_BaseDrawing HashTable
	 *
	 * @var Plugins_PHPExcel_HashTable
	 */
    ...
    /**
     * Create a new Plugins_PHPExcel_Writer_Excel2007
     *
    ...
    public function __construct(PHPExcel $pPHPExcel = null)
    {
    	...
    	$writerPartsArray = array(	'stringtable'	=> 'Plugins_PHPExcel_Writer_Excel2007_StringTable',
									'contenttypes'	=> 'Plugins_PHPExcel_Writer_Excel2007_ContentTypes',
									'docprops' 		=> 'Plugins_PHPExcel_Writer_Excel2007_DocProps',
									'rels'			=> 'Plugins_PHPExcel_Writer_Excel2007_Rels',
									'theme' 		=> 'Plugins_PHPExcel_Writer_Excel2007_Theme',
									'style' 		=> 'Plugins_PHPExcel_Writer_Excel2007_Style',
									'workbook' 		=> 'Plugins_PHPExcel_Writer_Excel2007_Workbook',
									'worksheet' 	=> 'Plugins_PHPExcel_Writer_Excel2007_Worksheet',
									'drawing' 		=> 'Plugins_PHPExcel_Writer_Excel2007_Drawing',
									'comments' 		=> 'Plugins_PHPExcel_Writer_Excel2007_Comments',
									'chart'			=> 'Plugins_PHPExcel_Writer_Excel2007_Chart',
									'relsvba'		=> 'Plugins_PHPExcel_Writer_Excel2007_RelsVBA',
									'relsribbonobjects' => 'Plugins_PHPExcel_Writer_Excel2007_RelsRibbon'
								 );
		...
		foreach ($hashTablesArray as $tableName) {
			$this->$tableName 	= new Plugins_PHPExcel_HashTable();
		}
    }
	 ...
	 * @return 	Plugins_PHPExcel_Writer_Excel2007_WriterPart
	 */
	...
	public function save($pFilename = null)
	{
		if ($this->_spreadSheet !== NULL) {
			...
			if (strtolower($pFilename) == 'php://output' || strtolower($pFilename) == 'php://stdout') {
				$pFilename = @tempnam(Plugins_PHPExcel_Shared_File::sys_get_temp_dir(), 'phpxltmp');
				if ($pFilename == '') {
					$pFilename = $originalFilename;
				}
			}

			$saveDebugLog = Plugins_PHPExcel_Calculation::getInstance($this->_spreadSheet)->getDebugLog()->getWriteDebugLog();
			Plugins_PHPExcel_Calculation::getInstance($this->_spreadSheet)->getDebugLog()->setWriteDebugLog(FALSE);
			...
			if ($objZip->open($pFilename, $zipOverWrite) !== true) {
				if ($objZip->open($pFilename, $zipCreate) !== true) {
					throw new Plugins_PHPExcel_Writer_Exception("Could not open " . $pFilename . " for writing.");
				}
			}
			...
			for ($i = 0; $i < $this->getDrawingHashTable()->count(); ++$i) {
				if ($this->getDrawingHashTable()->getByIndex($i) instanceof Plugins_PHPExcel_Worksheet_Drawing) {
					$imageContents = null;
				...
				} else if ($this->getDrawingHashTable()->getByIndex($i) instanceof Plugins_PHPExcel_Worksheet_MemoryDrawing) {
					ob_start();
					call_user_func(
			...
			Plugins_PHPExcel_Calculation::getInstance($this->_spreadSheet)->getDebugLog()->setWriteDebugLog($saveDebugLog);

			// Close file
			if ($objZip->close() === false) {
				throw new Plugins_PHPExcel_Writer_Exception("Could not close zip file $pFilename.");
			}

			// If a temporary file was used, copy it to the correct file stream
			if ($originalFilename != $pFilename) {
				if (copy($pFilename, $originalFilename) === false) {
					throw new Plugins_PHPExcel_Writer_Exception("Could not copy temporary zip file $pFilename to $originalFilename.");
				}
				@unlink($pFilename);
			}
		} else {
			throw new Plugins_PHPExcel_Writer_Exception("PHPExcel object unassigned.");
		}
	}
	...
	public function getPHPExcel() {
		if ($this->_spreadSheet !== null) {
			...
			throw new Plugins_PHPExcel_Writer_Exception("No PHPExcel assigned.");
		}
	}
	 ...
	 * @throws	Plugins_PHPExcel_Writer_Exception
	 * @return Plugins_PHPExcel_Writer_Excel2007
	 */
    ...
    /**
     * Get Plugins_PHPExcel_Style HashTable
     *
     * @return Plugins_PHPExcel_HashTable
     */
    ...
    /**
     * Get Plugins_PHPExcel_Style_Conditional HashTable
     *
     * @return Plugins_PHPExcel_HashTable
     */
    ...
    /**
     * Get Plugins_PHPExcel_Style_Fill HashTable
     *
     * @return Plugins_PHPExcel_HashTable
     */
    ...
    /**
     * Get Plugins_PHPExcel_Style_Font HashTable
     *
     * @return Plugins_PHPExcel_HashTable
     */
    ...
    /**
     * Get Plugins_PHPExcel_Style_Borders HashTable
     *
     * @return Plugins_PHPExcel_HashTable
     */
    ...
    /**
     * Get Plugins_PHPExcel_Style_NumberFormat HashTable
     *
     * @return Plugins_PHPExcel_HashTable
     */
    ...
    /**
     * Get Plugins_PHPExcel_Worksheet_BaseDrawing HashTable
     *
     * @return Plugins_PHPExcel_HashTable
     */
