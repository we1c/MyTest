...
/**
 * Plugins_PHPExcel_Writer_Excel2007_Chart
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Writer_Excel2007_Chart extends Plugins_PHPExcel_Writer_Excel2007_WriterPart
{
	/**
	 ...
	 */
	public function writeChart(Plugins_PHPExcel_Chart $pChart = null)
	{
		// Create XML writer
		$objWriter = null;
	 ...
	 * Write Chart Title
	 *
	 * @param	Plugins_PHPExcel_Chart_Title		$title
	 * @param 	Plugins_PHPExcel_Shared_XMLWriter 	$objWriter 		XML Writer
	 * @throws 	Plugins_PHPExcel_Writer_Exception
	 */
	private function _writeTitle(Plugins_PHPExcel_Chart_Title $title = null, $objWriter)
	{
		if (is_null($title)) {
			return;
		}
	 ...
	 * Write Chart Legend
	 *
	 * @param	Plugins_PHPExcel_Chart_Legend		$legend
	 * @param 	Plugins_PHPExcel_Shared_XMLWriter 	$objWriter 		XML Writer
	 * @throws 	Plugins_PHPExcel_Writer_Exception
	 */
	private function _writeLegend(Plugins_PHPExcel_Chart_Legend $legend = null, $objWriter)
	{
		if (is_null($legend)) {
			return;
		}
	 ...
	 *
	 * @param	Plugins_PHPExcel_Chart_PlotArea		$plotArea
	 * @param	Plugins_PHPExcel_Chart_Title		$xAxisLabel
	 * @param	Plugins_PHPExcel_Chart_Title		$yAxisLabel
	 * @param 	Plugins_PHPExcel_Shared_XMLWriter 	$objWriter 		XML Writer
	 * @throws 	Plugins_PHPExcel_Writer_Exception
	 */
	private function _writePlotArea(Plugins_PHPExcel_Chart_PlotArea $plotArea,
									Plugins_PHPExcel_Chart_Title $xAxisLabel = NULL,
									Plugins_PHPExcel_Chart_Title $yAxisLabel = NULL,
									$objWriter,
									Plugins_PHPExcel_Worksheet $pSheet)
	{
		if (is_null($plotArea)) {
			return;
		}
				...
				$objWriter->startElement('c:'.$chartType);
					...
					for($i = 0; $i < $groupCount; ++$i) {
						...
						if ($groupType == $chartType) {
							...
							if ($groupType === Plugins_PHPExcel_Chart_DataSeries::TYPE_RADARCHART) {
								$objWriter->startElement('c:radarStyle');
									$objWriter->writeAttribute('val', $plotStyle );
								$objWriter->endElement();
							} elseif ($groupType === Plugins_PHPExcel_Chart_DataSeries::TYPE_SCATTERCHART) {
					...
					if ($chartType === Plugins_PHPExcel_Chart_DataSeries::TYPE_LINECHART) {
						//	Line only, Line3D can't be smoothed

						$objWriter->startElement('c:smooth');
							$objWriter->writeAttribute('val', (integer) $plotGroup->getSmoothLine() );
						$objWriter->endElement();
					} elseif (($chartType === Plugins_PHPExcel_Chart_DataSeries::TYPE_BARCHART) ||
						($chartType === Plugins_PHPExcel_Chart_DataSeries::TYPE_BARCHART_3D)) {
						...
						if ($plotGroupingType == 'percentStacked' ||
					...
					} elseif ($chartType === Plugins_PHPExcel_Chart_DataSeries::TYPE_BUBBLECHART) {
							...
							$objWriter->startElement('c:showNegBubbles');
								$objWriter->writeAttribute('val', 0 );
							$objWriter->endElement();
					} elseif ($chartType === Plugins_PHPExcel_Chart_DataSeries::TYPE_STOCKCHART) {
...
//					} while ($id1 == $id2);
					...
					if (($chartType !== Plugins_PHPExcel_Chart_DataSeries::TYPE_PIECHART) &&
						($chartType !== Plugins_PHPExcel_Chart_DataSeries::TYPE_PIECHART_3D) &&
						($chartType !== Plugins_PHPExcel_Chart_DataSeries::TYPE_DONUTCHART)) {
						...
						if ($chartType === Plugins_PHPExcel_Chart_DataSeries::TYPE_DONUTCHART) {
			...
			if (($chartType !== Plugins_PHPExcel_Chart_DataSeries::TYPE_PIECHART) &&
				...
				if ($chartType === Plugins_PHPExcel_Chart_DataSeries::TYPE_BUBBLECHART) {
	 ...
	 *
	 * @param 	Plugins_PHPExcel_Shared_XMLWriter 	$objWriter 		XML Writer
	 * @param 	Plugins_PHPExcel_Chart_Layout		$chartLayout	Chart layout
	 * @throws 	Plugins_PHPExcel_Writer_Exception
	 */
	 ...
	 * @throws 	Plugins_PHPExcel_Writer_Exception
	 */
	private function _writeCatAx($objWriter, Plugins_PHPExcel_Chart_PlotArea $plotArea, $xAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries)
	{
...
//										$objWriter->writeAttribute('xml:space', 'preserve');
										$objWriter->writeRawData(Plugins_PHPExcel_Shared_String::ControlCharacterPHP2OOXML( $caption ));
									$objWriter->endElement();
	 ...
	 * @throws 	Plugins_PHPExcel_Writer_Exception
	 */
	private function _writeValAx($objWriter, Plugins_PHPExcel_Chart_PlotArea $plotArea, $yAxisLabel, $groupType, $id1, $id2, $isMultiLevelSeries)
	{
...
//										$objWriter->writeAttribute('xml:space', 'preserve');
					...
					if ($groupType !== Plugins_PHPExcel_Chart_DataSeries::TYPE_BUBBLECHART) {
	...
	private static function _getChartType($plotArea)
	{
		...
		if ($groupCount == 1) {
			...
			if (count($chartTypes) == 0) {
				throw new Plugins_PHPExcel_Writer_Exception('Chart is not yet implemented');
			}
		}
	 ...
	 *
	 * @param	Plugins_PHPExcel_Chart_DataSeries		$plotGroup
									...
									)
	{
		...
		if (($groupType == Plugins_PHPExcel_Chart_DataSeries::TYPE_BARCHART) ||
			($groupType == Plugins_PHPExcel_Chart_DataSeries::TYPE_BARCHART_3D)) {
		...
		if (($groupType !== Plugins_PHPExcel_Chart_DataSeries::TYPE_RADARCHART) &&
			($groupType !== Plugins_PHPExcel_Chart_DataSeries::TYPE_STOCKCHART)) {

			if ($groupType !== Plugins_PHPExcel_Chart_DataSeries::TYPE_LINECHART) {
				if (($groupType == Plugins_PHPExcel_Chart_DataSeries::TYPE_PIECHART) ||
					($groupType == Plugins_PHPExcel_Chart_DataSeries::TYPE_PIECHART_3D) ||
					($groupType == Plugins_PHPExcel_Chart_DataSeries::TYPE_DONUTCHART) ||
					($plotSeriesCount > 1)) {
		...
		foreach($plotSeriesOrder as $plotSeriesIdx => $plotSeriesRef) {
			$objWriter->startElement('c:ser');
				...
				if (($groupType == Plugins_PHPExcel_Chart_DataSeries::TYPE_LINECHART) ||
					...
					$objWriter->startElement('c:spPr');
						$objWriter->startElement('a:ln');
            				...
            				if ($groupType == Plugins_PHPExcel_Chart_DataSeries::TYPE_STOCKCHART) {
				...
				if (($groupType === Plugins_PHPExcel_Chart_DataSeries::TYPE_BARCHART) ||
					($groupType === Plugins_PHPExcel_Chart_DataSeries::TYPE_BARCHART_3D) ||
					($groupType === Plugins_PHPExcel_Chart_DataSeries::TYPE_BUBBLECHART)) {
				...
				if ($plotSeriesCategory && ($plotSeriesCategory->getPointCount() > 0)) {
					...
					if (($groupType === Plugins_PHPExcel_Chart_DataSeries::TYPE_BUBBLECHART) ||
						($groupType === Plugins_PHPExcel_Chart_DataSeries::TYPE_SCATTERCHART)) {
	 ...
	 *
	 * @param	Plugins_PHPExcel_Chart_DataSeriesValues		$plotSeriesLabel
	 * @param 	Plugins_PHPExcel_Shared_XMLWriter 			$objWriter 			XML Writer
	 * @throws 	Plugins_PHPExcel_Writer_Exception
	 */
	 ...
	 *
	 * @param	Plugins_PHPExcel_Chart_DataSeriesValues		$plotSeriesValues
	 * @param 	Plugins_PHPExcel_Shared_XMLWriter 			$objWriter 			XML Writer
	 * @param	string								$groupType			Type of plot for dataseries
	 ...
	 * @throws 	Plugins_PHPExcel_Writer_Exception
	 */
	private function _writeBubbles($plotSeriesValues, $objWriter, Plugins_PHPExcel_Worksheet $pSheet)
	{
		if (is_null($plotSeriesValues)) {
			return;
		}
	 ...
	 * Write Layout
	 *
	 * @param	Plugins_PHPExcel_Chart_Layout		$layout
	 * @param 	Plugins_PHPExcel_Shared_XMLWriter 	$objWriter 		XML Writer
	 * @throws 	Plugins_PHPExcel_Writer_Exception
	 */
	private function _writeLayout(Plugins_PHPExcel_Chart_Layout $layout = NULL, $objWriter)
	{
