...
/**
 * Plugins_PHPExcel_Writer_Excel2007_Theme
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Writer_Excel2007
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Writer_Excel2007_Theme extends Plugins_PHPExcel_Writer_Excel2007_WriterPart
{
	/**
	 ...
	 *
	 * @param 	Plugins_PHPExcel_Shared_XMLWriter	$objWriter
