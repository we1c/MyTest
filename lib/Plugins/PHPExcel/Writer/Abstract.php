 ...
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Writer
...
/**
 * Plugins_PHPExcel_Writer_Abstract
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Writer
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
abstract class Plugins_PHPExcel_Writer_Abstract implements Plugins_PHPExcel_Writer_IWriter
{
	/**
	...
	public function setUseDiskCaching($pValue = FALSE, $pDirectory = NULL) {
		...
		if ($pDirectory !== NULL) {
    		if (is_dir($pDirectory)) {
    			...
    			throw new Plugins_PHPExcel_Writer_Exception("Directory does not exist: $pDirectory");
    		}
		}
		return $this;
	}
