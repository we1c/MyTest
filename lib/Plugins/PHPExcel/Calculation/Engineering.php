...
/**
 * Plugins_PHPExcel_Calculation_Engineering
 *
 * @category	PHPExcel
 * @package		Plugins_PHPExcel_Calculation
 * @copyright	Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Calculation_Engineering {
	...
	public static function BESSELI($x, $ord) {
		$x	= (is_null($x))	? 0.0 :	Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($x);
		$ord	= (is_null($ord))	? 0.0 :	Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($ord);
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			if (abs($x) <= 30) {
				$fResult = $fTerm = pow($x / 2, $ord) / Plugins_PHPExcel_Calculation_MathTrig::FACT($ord);
				$ordK = 1;
				$fSqrX = ($x * $x) / 4;
				do {
					$fTerm *= $fSqrX;
			...
			return (is_nan($fResult)) ? Plugins_PHPExcel_Calculation_Functions::NaN() : $fResult;
		}
	...
	public static function BESSELK($x, $ord) {
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			return (is_nan($fBk)) ? Plugins_PHPExcel_Calculation_Functions::NaN() : $fBk;
		}
		return Plugins_PHPExcel_Calculation_Functions::VALUE();
	}	//	function BESSELK()
	...
	public static function BESSELY($x, $ord) {
		...
		if ((is_numeric($x)) && (is_numeric($ord))) {
			...
			return (is_nan($fBy)) ? Plugins_PHPExcel_Calculation_Functions::NaN() : $fBy;
		}
		return Plugins_PHPExcel_Calculation_Functions::VALUE();
	}	//	function BESSELY()
	...
	public static function BINTOHEX($x, $places=NULL) {
		$x	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($x);
		$places	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($places);
	...
	public static function COMPLEX($realNumber=0.0, $imaginary=0.0, $suffix='i') {
		$realNumber	= (is_null($realNumber))	? 0.0 :	Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($realNumber);
		$imaginary	= (is_null($imaginary))		? 0.0 :	Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($imaginary);
		$suffix		= (is_null($suffix))		? 'i' :	Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($suffix);
	...
	public static function IMAGINARY($complexNumber) {
		$complexNumber	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber);
	...
	public static function IMPOWER($complexNumber,$realNumber) {
		$complexNumber	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber);
		$realNumber		= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($realNumber);
	...
	public static function IMDIV($complexDividend,$complexDivisor) {
		$complexDividend	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($complexDividend);
		$complexDivisor	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($complexDivisor);
	...
	public static function IMSUB($complexNumber1,$complexNumber2) {
		$complexNumber1	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber1);
		$complexNumber2	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($complexNumber2);
	...
	public static function GESTEP($number, $step=0) {
		...
		$step	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($step);
	...
	public static function ERF($lower, $upper = NULL) {
		$lower	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($lower);
		$upper	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($upper);
	...
	public static function CONVERTUOM($value, $fromUOM, $toUOM) {
		...
		$fromUOM	= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($fromUOM);
		$toUOM		= Plugins_PHPExcel_Calculation_Functions::flattenSingleValue($toUOM);
