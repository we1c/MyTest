...
/**
 * Plugins_PHPExcel_CachedObjectStorage_DiscISAM
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_CachedObjectStorage_DiscISAM extends Plugins_PHPExcel_CachedObjectStorage_CacheBase implements Plugins_PHPExcel_CachedObjectStorage_ICache {
	...
	public function __construct(Plugins_PHPExcel_Worksheet $parent, $arguments) {
		$this->_cacheDirectory	= ((isset($arguments['dir'])) && ($arguments['dir'] !== NULL))
									? $arguments['dir']
									: Plugins_PHPExcel_Shared_File::sys_get_temp_dir();
