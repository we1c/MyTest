...
/**
 * Plugins_PHPExcel_CachedObjectStorage_MemorySerialized
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_CachedObjectStorage_MemorySerialized extends Plugins_PHPExcel_CachedObjectStorage_CacheBase implements Plugins_PHPExcel_CachedObjectStorage_ICache {
