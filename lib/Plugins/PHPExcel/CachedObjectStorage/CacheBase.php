...
/**
 * Plugins_PHPExcel_CachedObjectStorage_CacheBase
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_CachedObjectStorage
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
abstract class Plugins_PHPExcel_CachedObjectStorage_CacheBase {
	 ...
	 */
	public function __construct(Plugins_PHPExcel_Worksheet $parent) {
		//	Set our parent worksheet.
		//	This is maintained within the cache controller to facilitate re-attaching it to Plugins_PHPExcel_Cell objects when
	...
	public function getHighestColumn($row = null)
	{
        ...
        foreach ($this->getCellList() as $coord) {
            ...
            $columnList[] = Plugins_PHPExcel_Cell::columnIndexFromString($c);
        }
        return Plugins_PHPExcel_Cell::stringFromColumnIndex(max($columnList) - 1);
    }
