...
/**
 * Plugins_PHPExcel_Style_Color
 *
 * @category   PHPExcel
 * @package	Plugins_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Style_Color extends Plugins_PHPExcel_Style_Supervisor implements Plugins_PHPExcel_IComparable
{
	/* Colors */
	...
	/**
	 * Create a new Plugins_PHPExcel_Style_Color
	 *
	 ...
	 *										its ramifications are
	 */
	public function __construct($pARGB = Plugins_PHPExcel_Style_Color::COLOR_BLACK, $isSupervisor = FALSE, $isConditional = FALSE)
	{
		//	Supervisor?
	 ...
	 * @return Plugins_PHPExcel_Style_Color
	 */
	public function setARGB($pValue = Plugins_PHPExcel_Style_Color::COLOR_BLACK) {
		if ($pValue == '') {
			$pValue = Plugins_PHPExcel_Style_Color::COLOR_BLACK;
		}
		if ($this->_isSupervisor) {
	...
	public static function indexedColor($pIndex, $background=FALSE) {
		...
		if (array_key_exists($pIndex, self::$_indexedColors)) {
			return new Plugins_PHPExcel_Style_Color(self::$_indexedColors[$pIndex]);
		}

		if ($background) {
			return new Plugins_PHPExcel_Style_Color('FFFFFFFF');
		}
		return new Plugins_PHPExcel_Style_Color('FF000000');
	}
