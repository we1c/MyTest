...
/**
 * Plugins_PHPExcel_Style_Alignment
 *
 * @category   PHPExcel
 * @package	Plugins_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Style_Alignment extends Plugins_PHPExcel_Style_Supervisor implements Plugins_PHPExcel_IComparable
{
	 ...
	 * @var string
	 */
	protected $_horizontal	= Plugins_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL;
	 ...
	 * @var string
	 */
	protected $_vertical		= Plugins_PHPExcel_Style_Alignment::VERTICAL_BOTTOM;
	...
	/**
	 * Create a new Plugins_PHPExcel_Style_Alignment
	 *
	 ...
	 *		array(
	 *			'horizontal' => Plugins_PHPExcel_Style_Alignment::HORIZONTAL_CENTER,
	 *			'vertical'   => Plugins_PHPExcel_Style_Alignment::VERTICAL_CENTER,
	 *			'rotation'   => 0,
	 *			'wrap'			=> TRUE
	 *		)
	 * );
	 ...
	 * @return Plugins_PHPExcel_Style_Alignment
	 */
	public function setHorizontal($pValue = Plugins_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL) {
		if ($pValue == '') {
			$pValue = Plugins_PHPExcel_Style_Alignment::HORIZONTAL_GENERAL;
		}
	 ...
	 * @return Plugins_PHPExcel_Style_Alignment
	 */
	public function setVertical($pValue = Plugins_PHPExcel_Style_Alignment::VERTICAL_BOTTOM) {
		if ($pValue == '') {
			$pValue = Plugins_PHPExcel_Style_Alignment::VERTICAL_BOTTOM;
		}
	...
	public function setTextRotation($pValue = 0) {
		...
		if ( ($pValue >= -90 && $pValue <= 90) || $pValue == -165 ) {
			...
			throw new Plugins_PHPExcel_Exception("Text rotation should be a value between -90 and 90.");
		}
