...
/**
 * Plugins_PHPExcel_Style_Protection
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Style_Protection extends Plugins_PHPExcel_Style_Supervisor implements Plugins_PHPExcel_IComparable
{
	/** Protection styles */
	...
	/**
     * Create a new Plugins_PHPExcel_Style_Protection
	 *
