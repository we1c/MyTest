...
/**
 * Plugins_PHPExcel_Style_Font
 *
 * @category   PHPExcel
 * @package	Plugins_PHPExcel_Style
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Style_Font extends Plugins_PHPExcel_Style_Supervisor implements Plugins_PHPExcel_IComparable
{
	/* Underline types */
	...
	/**
	 * Create a new Plugins_PHPExcel_Style_Font
	 *
	...
	public function __construct($isSupervisor = FALSE, $isConditional = FALSE)
	{
		...
		if ($isConditional) {
			...
			$this->_color			= new Plugins_PHPExcel_Style_Color(Plugins_PHPExcel_Style_Color::COLOR_BLACK, $isSupervisor, $isConditional);
		} else {
	 ...
	 * Set Underline
	 *
	 * @param string|boolean $pValue	Plugins_PHPExcel_Style_Font underline type
