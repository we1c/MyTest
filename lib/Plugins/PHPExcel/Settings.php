 ...
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Settings
...
class Plugins_PHPExcel_Settings
{
    /**    constants */
    /**    Available Zip library classes */
    const PCLZIP        = 'Plugins_PHPExcel_Shared_ZipArchive';
     ...
     * 	 e.g. Plugins_PHPExcel_Settings::PCLZip or Plugins_PHPExcel_Settings::ZipArchive
    ...
    {
        return Plugins_PHPExcel_CachedObjectStorageFactory::getCacheStorageMethod();
    ...
    {
        return Plugins_PHPExcel_CachedObjectStorageFactory::getCacheStorageClass();
    ...
    public static function setCacheStorageMethod(
    	$method = Plugins_PHPExcel_CachedObjectStorageFactory::cache_in_memory,
      $arguments = array()
    )
    {
        return Plugins_PHPExcel_CachedObjectStorageFactory::initialize($method, $arguments);
    ...
    {
        return Plugins_PHPExcel_Calculation::getInstance()->setLocale($locale);
    } // function setLocale()
     ...
     *	e.g. Plugins_PHPExcel_Settings::CHART_RENDERER_JPGRAPH
     ...
     *
     * @param string $libraryName Internal reference name of the library
     * 	e.g. Plugins_PHPExcel_Settings::PDF_RENDERER_TCPDF,
     * 	Plugins_PHPExcel_Settings::PDF_RENDERER_DOMPDF
     *  or Plugins_PHPExcel_Settings::PDF_RENDERER_MPDF
     * @param string $libraryBaseDir Directory path to the library's base folder
     *
     * @return boolean Success or failure
     */
