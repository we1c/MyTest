...
/**
 * Plugins_PHPExcel_Reader_Excel5_MD5
 *
 * @category        PHPExcel
 * @package                Plugins_PHPExcel_Reader_Excel5
 * @copyright        Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Reader_Excel5_MD5
{
    // Context
    private $a;
    private $b;
    ...
    public function add($data)
    {
        ...
        $F = array('Plugins_PHPExcel_Reader_Excel5_MD5','F');
        $G = array('Plugins_PHPExcel_Reader_Excel5_MD5','G');
        $H = array('Plugins_PHPExcel_Reader_Excel5_MD5','H');
        $I = array('Plugins_PHPExcel_Reader_Excel5_MD5','I');
