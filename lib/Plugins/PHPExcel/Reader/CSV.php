...
/**
 * Plugins_PHPExcel_Reader_CSV
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Reader
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Reader_CSV extends Plugins_PHPExcel_Reader_Abstract implements Plugins_PHPExcel_Reader_IReader
{
	/**
	 * Input encoding
	 *
	...
	/**
	 * Create a new Plugins_PHPExcel_Reader_CSV
	 */
			...
			foreach($rowData as $rowDatum) {
				if ($rowDatum != '' && $this->_readFilter->readCell($columnLetter, $currentRow)) {
					...
					if ($this->_inputEncoding !== 'UTF-8') {
						$rowDatum = Plugins_PHPExcel_Shared_String::ConvertEncoding($rowDatum, 'UTF-8', $this->_inputEncoding);
					}
	 ...
	 * @return	Plugins_PHPExcel_Reader_CSV
	 */
