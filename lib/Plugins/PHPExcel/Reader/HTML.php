...
/**
 * Plugins_PHPExcel_Reader_HTML
 *
 * @category   PHPExcel
 * @package    Plugins_PHPExcel_Reader
 * @copyright  Copyright (c) 2006 - 2014 PHPExcel (http://www.codeplex.com/PHPExcel)
 */
class Plugins_PHPExcel_Reader_HTML extends Plugins_PHPExcel_Reader_Abstract implements Plugins_PHPExcel_Reader_IReader
{
	/**
	 * Input encoding
	 *
	...
	private $_formats = array( 'h1' => array( 'font' => array( 'bold' => true,
							   ...
							   'a'  => array( 'font' => array( 'underline' => true,
															   'color' => array( 'argb' => Plugins_PHPExcel_Style_Color::COLOR_BLUE,
															                   ),
															 ),
											),	//	Blue underlined
							   'hr' => array( 'borders' => array( 'bottom' => array( 'style' => Plugins_PHPExcel_Style_Border::BORDER_THIN,
																					 'color' => array( Plugins_PHPExcel_Style_Color::COLOR_BLACK,
																					                 ),
																				   ),
																),
											),	//	Bottom border
	...
	/**
	 * Create a new Plugins_PHPExcel_Reader_HTML
	 */
...
//						echo 'END OF TABLE ' , $this->_tableLevel , ' CELL<br />';
	...
	public function loadIntoExisting($pFilename, PHPExcel $objPHPExcel)
	{
		...
		if (!$this->_isValidFormat()) {
			...
			throw new Plugins_PHPExcel_Reader_Exception($pFilename . " is an Invalid HTML file.");
		}
		...
		$loaded = $dom->loadHTMLFile($pFilename, Plugins_PHPExcel_Settings::getLibXmlLoaderOptions());
		if ($loaded === FALSE) {
			throw new Plugins_PHPExcel_Reader_Exception('Failed to load ',$pFilename,' as a DOM Document');
		}
...
//		var_dump($this->_dataArray);
	 ...
	 * @return Plugins_PHPExcel_Reader_HTML
	 */
