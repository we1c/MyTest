...
if( !defined('IMAGE_CLASS_ROOT') ){
    define( 'IMAGE_CLASS_ROOT',dirname(__FILE__).'/Plugins/' );
}
...
class Image{
    ...
    public function __construct($type = self::IMAGE_GD, $imgname = null){
        ...
        /* 引入处理库，实例化图片处理对象 */
        require_once( IMAGE_CLASS_ROOT.'Image/Driver/'.$class.'.class.php' );
